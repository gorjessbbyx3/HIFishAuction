...
class WeatherService:
    ...
    def update_weather_data(self):
        ...
        try:
            ...
            weather_data = {
                ...
                'wave_height': current_weather['wave_height'],
                'storm_warnings': current_weather['storm_warnings'],
            ...
            for forecast_day in forecast:
                forecast_data = {
                    ...
                    'wave_height': self._estimate_wave_height({'windSpeed': {'value': forecast_day['wind_speed'] / 1.944}}),
                    'storm_warnings': [] if forecast_day['storm_probability'] < 0.5 else ['Storm Risk'],
    ...
    def get_fishing_impact_score(self, weather_data: Dict) -> float:
        ...
        storm_impact = 1.0 if storm_warnings else 0.0
